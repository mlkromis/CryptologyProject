...
public class SHA3Handler extends AbstractAlgorithmHandler {
    ...
    public Object execute(ExecutionEvent event) {
        ...
        if (result == Window.OK) {
            ...
            String EchoOn = wizard.getEchoSelect();
            String JHOn = wizard.getJHSelect();
            String SkeinOn = wizard.getSkeinSelect();
            ...
            String Input = wizard.getInputText();
